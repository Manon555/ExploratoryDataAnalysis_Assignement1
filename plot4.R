### Exploratory Data Analysis Assignment 1 - R script for plot 4 ###
...
# divide canvas into 4 parts and fill it column-wise
par(mfcol=c(2,2)) 
...
legend("topright", lty=1, legend=names(data)[7:9], col=c("black","red","blue"), bty="n")
